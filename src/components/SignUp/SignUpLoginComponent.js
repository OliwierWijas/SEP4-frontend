...
function SignUpLogin({ textArrayToDisplay, usernameNeeded, passwordNeeded, repeatPasswordNeeded, mainButtonText, mark, smallText, smallButtonText, action, linkTo }) {
    return (
        <div className="brown-gradient w-full flex flex-col lg:flex-row shadow-md rounded-lg my-10">
            ...
            <div className="bg-white h-96 w-full lg:w-1/3 rounded-b-lg bg-opacity-15 flex items-center justify-center flex-col">
                <FormComponent usernameNeeded={usernameNeeded} passwordNeeded={passwordNeeded} repeatPasswordNeeded={repeatPasswordNeeded} buttonText={mainButtonText} action={action}  />
