...
function PopUp({ children, isOpen, setIsOpen }) {
    ...
    return (
        <div className={`${isOpen ? "fixed z-10" : "hidden z-0"} top-0 left-0 w-full h-full bg-gray-800 bg-opacity-10 backdrop-filter backdrop-blur-sm flex items-center justify-center`} data-testid="popup">
            <IoClose
